...
export class InitialMigration1770575836999 implements MigrationInterface {
  name = 'InitialMigration1770575836999';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Create initial tables, user, role and user_role, create relation between user and role with user_role
    ...
    await queryRunner.query(
      `INSERT INTO "user" (name,lastname,birthdate,phone,email, password) VALUES ('lorems', 'input', '01/01/2000','1234567890','seed@gmail.com','pss1')`,
    );
    await queryRunner.query(
